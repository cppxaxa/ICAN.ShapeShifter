...
# .json manifests
WORK_DIR = "."
MODEL_YAML = "../checkpoint/jasper10x5dr.yaml"
CHECKPOINT_ENCODER = "../checkpoint/JasperEncoder-STEP-265520.pt"
CHECKPOINT_DECODER = "../checkpoint/JasperDecoderForCTC-STEP-265520.pt"
